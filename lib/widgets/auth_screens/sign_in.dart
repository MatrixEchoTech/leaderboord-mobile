...
class _SignInState extends State<SignIn> {
  ...
  bool rememberMe = false; // persistent state for checkbox
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('/images/auth-bg.png'), // background image
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
                      ...
                      Row(
                        children: [
                          Checkbox(
                            ...
                            activeColor: Colors.white, // box color when checked
